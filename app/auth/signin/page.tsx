...
export default function SignInPage() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      setError(err.message || 'Gagal sign in dengan Google')
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <p className="text-gray-600 mb-6">Sign in to your OASIS BI PRO account</p>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full py-3 border-2 border-gray-300 rounded-lg font-semibold hover:bg-gray-50 transition-all flex items-center justify-center space-x-2"
            >
